...
<Callout type="info" emoji="✅">
	**Stable versions** - components that need no further updates for working
	features and are currently fine-grained to use. <br />
</Callout>

<Callout type="warning" emoji="⚠️">
	**Unstable versions** - are currently in updates and may have strict changes
	in props or use cases. Whenever using an unstable Component, it is a good
	practice to go through the latest documentation...
</Callout>
